...
urlpatterns = [
    ...
    path('detailAteliers/<int:idatelier>/<int:idclient>', views.detail_atelier, name="detailAteliers"),
    ...
    path('resetPasswordStep/<str:username>/<str:adresse_mail>', views.reset_password_step_2, name="resset_password_step"),
]
